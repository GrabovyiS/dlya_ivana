 ...
 * то возвращает на него ответ. Если совпадение найти не удалось, то ввод пользователя передается в класс
 * StatisticTeacher для обучения системы, а пользователю восвращается заранее подготовленная строка.
 */
